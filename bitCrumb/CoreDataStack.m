...
//  Diary
//
//  Created by Levi Thornton on 10/21/14.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Crum" withExtension:@"mmmddd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"BitCrum.sqlite"];
    NSError *error = nil;
